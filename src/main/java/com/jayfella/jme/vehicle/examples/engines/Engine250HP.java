...
public class Engine250HP extends Engine {
    ...
    final private static Logger logger
            = Logger.getLogger(Engine250HP.class.getName());
    /**
    ...
    final private static Vector3f[] points = new Vector3f[]{
        ...
        new Vector3f(3_000f, 0.65f, 0f),
        new Vector3f(4_000f, 0.75f, 0f),
        new Vector3f(5_000f, 0.99f, 0f),
        new Vector3f(6_000f, 0.95f, 0f),
        new Vector3f(7_000f, 0.70f, 0f),
        new Vector3f(7_500f, 0.60f, 0f)
    };
    // *************************************************************************
    // fields
     ...
     */
    public Engine250HP() {
        super("Basic 250", 250f * HP_TO_W, 600f, 5_500f);
