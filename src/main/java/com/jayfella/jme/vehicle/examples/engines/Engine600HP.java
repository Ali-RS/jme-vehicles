...
/**
 * A 600-horsepower engine with a 600-RPM idle and a 9,000-RPM redline.
 */
public class Engine600HP extends Engine {
    ...
    final private static Logger logger
            = Logger.getLogger(Engine600HP.class.getName());
    /**
    ...
    /**
     * Instantiate a 600-horsepower engine.
     */
    public Engine600HP() {
        super("Basic 600", 600f * HP_TO_W, 600f, 9_000f);
