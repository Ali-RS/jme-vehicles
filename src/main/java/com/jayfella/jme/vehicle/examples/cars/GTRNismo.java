...
public class GTRNismo extends Car {
    ...
    public GTRNismo(Application app) {
        ...
        addWheel(w_fr_node, new Vector3f(-0.94f, 0.3f, 1.4f), true, false, new Brake(140));
        addWheel(w_fl_node, new Vector3f(0.94f, 0.3f, 1.4f), true, false, new Brake(140));
        addWheel(w_rr_node, new Vector3f(-0.94f, 0.3f, -1.4f), false, false, new Brake(0));
        addWheel(w_rl_node, new Vector3f(0.94f, 0.3f, -1.4f), false, false, new Brake(0));
