...
/**
 * A Prop for a tall barrier painted black, built around a portion of Sabri
 * Ayeş's "Barrier &amp; Traffic Cone Pack".
 *
 * @author Stephen Gold sgold@sonic.net
 */
public class WallBarrier extends Prop {
    // *************************************************************************
    ...
    final public static Logger logger2
            = Logger.getLogger(WallBarrier.class.getName());
    // *************************************************************************
    // constructors
     ...
     */
    public WallBarrier(float scaleFactor, float totalMass) {
        super("WallBarrier", scaleFactor, totalMass);
    }
    // *************************************************************************
    // Prop methods
    ...
    public void load(AssetManager assetManager) {
        ...
        String assetPath = "/Models/Props/barrier_pack/wall_barrier.j3o";
        Spatial cgmRoot = assetManager.loadModel(assetPath);

        assetPath = "/Models/Props/barrier_pack/wall_barrier_hull.j3o";
