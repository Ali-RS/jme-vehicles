...
/**
 * A Prop for a tall barrier painted black and orange, built around a portion of
 * Sabri Ayeş's "Barrier & Traffic Cone Pack".
 *
 * @author Stephen Gold sgold@sonic.net
 */
public class WallBarrierPainted extends Prop {
    // *************************************************************************
    ...
    final public static Logger logger2
            = Logger.getLogger(WallBarrierPainted.class.getName());
    // *************************************************************************
    // constructors
    ...
    public void load(AssetManager assetManager) {
        ...
        String assetPath
                = "/Models/Props/barrier_pack/wall_barrier_painted.j3o";
        Spatial cgmRoot = assetManager.loadModel(assetPath);

        assetPath = "/Models/Props/barrier_pack/wall_barrier_painted_hull.j3o";
