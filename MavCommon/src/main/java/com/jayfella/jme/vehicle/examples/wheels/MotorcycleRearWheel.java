...
/**
 * A WheelModel built around the rear wheel of Hector Mora's "Classic
 * Motorcycle" model.
 *
 * @author Stephen Gold sgold@sonic.net
 */
public class MotorcycleRearWheel extends WheelModel {
    // *************************************************************************
    ...
    final private static Logger logger2
            = Logger.getLogger(MotorcycleRearWheel.class.getName());
    // *************************************************************************
    // constructors
     ...
     */
    public MotorcycleRearWheel(float diameter) {
        super(diameter);
    }
    // *************************************************************************
    // WheelModel methods
    ...
    public void load(AssetManager assetManager) {
        String assetPath = "/Models/classic_motorcycle/rear-wheel.j3o";
