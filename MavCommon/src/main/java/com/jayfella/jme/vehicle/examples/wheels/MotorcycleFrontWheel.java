...
/**
 * A WheelModel built around the front wheel of Hector Mora's "Classic
 * Motorcycle" model.
 *
 * @author Stephen Gold sgold@sonic.net
 */
public class MotorcycleFrontWheel extends WheelModel {
    // *************************************************************************
    ...
    final private static Logger logger2
            = Logger.getLogger(MotorcycleFrontWheel.class.getName());
    // *************************************************************************
    // constructors
     ...
     */
    public MotorcycleFrontWheel(float diameter) {
        super(diameter);
    }
    // *************************************************************************
    // WheelModel methods
    ...
    public void load(AssetManager assetManager) {
        String assetPath = "/Models/classic_motorcycle/front-wheel.j3o";
